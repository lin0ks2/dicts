 ...
 * Версия: 1.7 (база 1.2, подсветка, фикс навигации)
...
(function () {
  ...
  function init() {
    attachClickHandler();
    setupWordObserver();       // как в 1.2 — следим за сменой слова
    setupGlobalHomeObserver(); // новый: следим за появлением тренера после навигации
